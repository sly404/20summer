...
! function(a, b) {
	...
	}) : "object" == typeof exports ? module.exports = b(require("chartist")) : a["Chartist.plugins.tooltips"] = b(
		Chartist)
}(this, function(a) {
		...
		c.plugins = c.plugins || {}, c.plugins.tooltip = function(a) {
			return a = c.extend({}, i, a),
				function(i) {
					...
					function k(b) {
						o = o || n.offsetHeight, p = p || n.offsetWidth, a.appendToBody ? (n.style.top = b.pageY - o + a.tooltipOffset
							.y + "px", n.style.left = b.pageX - p / 2 + a.tooltipOffset.x + "px") : (n.style.top = (b.layerY || b.offsetY) -
							o + a.tooltipOffset.y + "px", n.style.left = (b.layerX || b.offsetX) - p / 2 + a.tooltipOffset.x + "px")
					}
					var l = "ct-point";
					i instanceof c.Bar ? l = "ct-bar" : i instanceof c.Pie && (l = i.options.donut ? "ct-slice-donut" :
						"ct-slice-pie");
					var m = i.container,
						n = m.querySelector(".chartist-tooltip");
					n || (n = b.createElement("div"), n.className = a["class"] ? "chartist-tooltip " + a["class"] :
						"chartist-tooltip", a.appendToBody ? b.body.appendChild(n) : m.appendChild(n));
					...
					e(n), j("mouseover", l, function(e) {
						...
						if (a.tooltipFnc) j = a.tooltipFnc(q, s);
							...
							s && (s = '<span class="chartist-tooltip-value">' + s + "</span>", a.currency && (s = a.currency + s.replace(
								/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, "$1,")), j += s)
						}
